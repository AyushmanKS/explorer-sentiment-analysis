...
const Hero = ({
  ...
  return (
    <section className="min-h-screen w-full flex items-end justify-center p-8">
      <div className="flex w-full items-center justify-center space-x-8">
        ...
        <div className="soft-container w-full max-w-5xl h-[520px] flex flex-col p-6">
          <div className="flex-grow grid grid-cols-2 gap-8 items-start min-h-0">
